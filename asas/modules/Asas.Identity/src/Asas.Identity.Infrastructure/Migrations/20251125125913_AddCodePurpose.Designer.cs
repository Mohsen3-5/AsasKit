...
namespace Asas.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20251125125913_AddCodePurpose")]
    partial class AddCodePurpose
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Asas.Identity.Domain.Entities.EmailConfirmationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Asas.Identity.Domain.Entities.UserDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Asas.Identity.Domain.Entities.EmailConfirmationCode", b =>
                {
                    b.HasOne("Asas.Identity.Domain.Entities.AsasUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

...
internal static class TenantModelBuilderExtensions
{
    ...
    private sealed class ContextTenantAccessor
    {
        ...
        public ContextTenantAccessor(DbContext ctx, Func<int?> get) { _ctx = ctx; _get = get; }
        public int? TenantId => _get(); // evaluated per query execution
    }
}
